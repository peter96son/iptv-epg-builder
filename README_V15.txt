...
v15.0.3 CI compatibility fix:
- physical-source deduplication applies only to absolute http/https URLs;
- placeholders such as "x" are never treated as duplicate endpoints;
- fixes test_v1414_live_fingerprint_sources without weakening real URL deduplication.
