...
def test_cps_ussr_unverified_offset_is_disabled():
    load_channel_time_offsets.cache_clear()
    assert channel_time_offset_minutes("openbox-tsd", "cps-ussr") == 0
...
def test_shift_helper_can_apply_fixed_offset_when_verified():
...
def test_shift_helper_rolls_programme_times_into_next_day():
