...
def test_xmltv_source_does_not_apply_disproved_cps_offset(monkeypatch):
    ...
    assert by_channel["cps-ussr"].get("start") == "20260820071100 -0700"
    assert by_channel["cps-ussr"].get("stop") == "20260820085100 -0700"
